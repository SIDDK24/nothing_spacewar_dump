...
cat system/system/priv-app/NTCamera/NTCamera.apk.* 2>/dev/null >> system/system/priv-app/NTCamera/NTCamera.apk
rm -f system/system/priv-app/NTCamera/NTCamera.apk.* 2>/dev/null
...
cat vendor_bootimg/14_dtbdump__\z.dtb.* 2>/dev/null >> vendor_bootimg/14_dtbdump__\z.dtb
rm -f vendor_bootimg/14_dtbdump__\z.dtb.* 2>/dev/null
